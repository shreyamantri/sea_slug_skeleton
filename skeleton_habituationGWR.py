...
for t in range(0, nTs): # iterates from the beginning to the end of the 'x' vector
    y [0, t] = v*x[t] # find the output
    if (x[t] > 0): # if input (vector x) at index t is greater than 0
        v = v*0.7 # then decrement the weight
